        ...
        <div className="leave-requests">
          ...
          <div className='set'>
            ...
            <button type="button" onClick={Leave} className="let">
              <img src={plus} alt="Apply Leave" height="20px" width="20px" style={{ marginRight: "8px" }} />
              Apply Leave
            </button>
          </div>
          {error && <p>{error}</p>}
          <table>
            ...
            <tbody>
              ...
              {newrowId === employee.id ? (
                <button  style={{backgroundColor:"black"}}onClick={() => handleSave(employee.id)}>
                  <i className="fas fa-save"></i>
                </button>
              ) : (
                <button style={{backgroundColor:"black"}} onClick={() => handleEdit(employee.id, employee.lev_status)}>
