...
try{
  ...
  console.error("Error occurred:", error);
    ...
    return (
        ...
        <input className='new3' placeholder='Enter your join date' onChange={(e) => setUanno(e.target.value)} type="date" name="join" id="join"/>
      
   <div className='center-button'>
                        <button className='newbutton'  onClick={employ} type='submit'>Submit</button>
                    </div>
                    </div>
                    <div style={{ backgroundColor: "#ffffff" }} className="fruits-column">
  ...
  <option value="Mern Stack Developer">Mern Stack Developer Trainee</option>
                    ...
                    <div className='center-button'>
                        <button className='newbutton' onClick={Upload} type='submit'>Upload files</button>
                    </div>
                    </div>
